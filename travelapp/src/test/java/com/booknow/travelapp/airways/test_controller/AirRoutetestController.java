package com.booknow.travelapp.airways.test_controller;
...
@Log4j
public class AirRoutetestController {
    ...
    public void testShowBoardList() throws Exception {
        log.info(mockMvc.perform(MockMvcRequestBuilders.get("/airways/list")
        						.param("서울","제주","20230627"))
                        .andReturn()
                        .getModelAndView());
                      //  .getModelMap());
    }
