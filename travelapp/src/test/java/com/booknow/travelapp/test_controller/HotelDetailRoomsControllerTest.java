package com.booknow.travelapp.test_controller;
...
@Log4j
public class HotelDetailRoomsControllerTest {
	   ...
	   //테스트 환경 구성 시작, 컨트롤러 테스트를 위해서는 WebApplicationContext 를 객체로 주입 받아야 합니다.
	    ...
	    //게시물 목록 조회 테스트 
	    @Test
	    public void testShowRoomList() throws Exception {
	        log.info(mockMvc.perform(MockMvcRequestBuilders.get("/tlbook/hotels/rooms/detail/list")
...
//	                                 .get("/myboard/detailmod")  // /myboard/modify로 수정하여 테스트
//	                                 .param("bno", "1"))
//	                          .andReturn()
//	                          .getModelAndView()
